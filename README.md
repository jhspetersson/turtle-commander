...
- Browse and modify archive contents (**A LOT** of archive file types supported), edit files inside archives, and even inside nested archives, extract files, create `.zip` and `.tar.gz` archives
